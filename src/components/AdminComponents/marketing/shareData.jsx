            ...
            <div className=''>
                ...
                <div className='flex flex-col pt-5'>
                    ...
                    <div className='flex justify-between items-center border px-2 rounded-md'>
                        <input type="text" placeholder='Code' className='w-full  h-[42px] ticket placeholder:text-[14px] rounded-md text-[#ACACAC] focus:outline-none px-2 ' />
                        <img src={copy} alt="copy" className='object-cover cursor-pointer' />
                    </div>
                </div>

                <div className='flex justify-end pt-5'>
                    <button className='bg-[#FF8C00] text-white h-[40px] w-full rounded-md'>Share</button>
                </div>
