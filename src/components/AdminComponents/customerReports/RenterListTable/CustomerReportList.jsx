...
const CustomerReportList = ({ setDetail }) => {
                                        ...
                                        currentItems.map((_, i) =>
                                            <tr className=' cursor-pointer  ' >
                                                ...
                                                <td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                                    <div className="text-left text-[14px] text-[#898989] px-1">Fortuner</div>
                                                </td>
                                                <td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
  ...
  "
                                                                    >
                                                                        {
                                                                            status.map((item, i) => (
                                                                                <li class="px-2 py-2 text-left mb-2" key={i}>
                                                                                    <div className="text-center py-[3px] px-2.5 w-auto text-[12px] rounded-full">
                                                                                        {item}</div>
                                                                                </li>
                                                                            ))
                                                                        }
                                                                ...
                                                                <li onClick={() => setShow(true)} class="rounded-sm flex items-center px-2 py-2 hover:bg-gray-100">
