        ...
        <>
            <div className='text-center p-5'>
                ...
                <div className='py-5'>
                        ...
                        <p className='text-[#666666] leading-[20px] text-[16px]'>Are you sure you want to delete this code</p>
                    <div className='pt-5'>
                        ...
                        <button className='w-[138px] py-2 ml-3 rounded-md bg-[#F04438] text-white'>Delete</button>
                    </div>
                </div>
            </div>
        </>
