      ...
      <div className="">
        ...
        <div className="flex flex-col pt-5">
          ...
          <input
            type="text"
            placeholder="Name"
            className="border border-[#CDD2E1] h-[42px] placeholder:text-[14px] text-[#ACACAC] text-sm rounded-md focus:outline-none px-2.5 "
          />
        </div>
        <div className="flex flex-col py-4">
          ...
          <input
            ...
            className="border border-[#CDD2E1] h-[42px] placeholder:text-[14px] rounded-md text-[#ACACAC] focus:outline-none px-2.5 "
          />
        </div>
