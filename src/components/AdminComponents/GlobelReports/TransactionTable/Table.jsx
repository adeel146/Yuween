            ...
            <div className=''>
                {
                    title === "Transaction" ?
                        <div className='flex lg:flex-nowrap flex-wrap justify-between items-center pb-5'>
                            <h2 className='text-[20px] font-semibold leading-[20.16px]  text-[#444444]'>Transaction</h2>
                            <div className='flex lg:py-0 py-2  xtra-small:block xxtra-small:block xtra-small:w-full xxtra-small:w-full'>
                                <div className='bg-white flex border-0 lg:flex items-center px-4 h-[45px] w-[380px] xxtra-small:w-full xtra-sm:w-full py-3 shadow-[0_4px_20px_0px_rgba(0,0,0,0.08)] rounded-full'>
                        ...
                        <h2 className='text-[20px] font-semibold leading-[20.16px] p-5 text-[#FF8C00]'>
                            {location === "/globelRenter" ? 'Top Highly Ranked  Renters': "Top Highly Ranked Owners"}
                        </h2>
