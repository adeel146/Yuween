    ...
    <>
      <div className="grid lg:grid-cols-2 xtra-small:grid-cols-1 xxtra-small:grid-cols-1 tablet:grid-cols-2 md:grid-cols-2 gap-5">
        <div className="shadow-[0_4px_20px_0px_rgba(0,0,0,0.08)] rounded-md border-b-[3px] border-[#2BA676]   h-auto p-4">
          <div className="flex flex-wrap cards-screen:flex-col items-center  justify-between">
            <h2 className="text-[#444444] lg:text-left cards-screen:text-center text-[14px] lg:order-0 md:order-1 leading-[24px] sidebar-expanded:max-w-[130px]  max-w-[200px]">
              Total Earnings
            </h2>
          ...
          <div>
            {Static?.earnings ? (
              <h2 className="lg:text-[24px] text-[20px] leading-[32px] font-medium lg:mt-2  text-[#2BA676] ">
                {Static?.earnings} FCFA
              </h2>
            ) : (
        ...
        <div className="flex flex-wrap cards-screen:flex-col items-center  justify-between">
          ...
          <div>
            {Static?.car_owners ? (
              <h2 className="lg:text-[24px] text-[20px] lg:text-left cards-screen:text-center leading-[32px] font-medium lg:mt-2  text-[#FF8C00] ">
                {Static?.car_owners}
              </h2>
            ) : (
      ...
      <div className="grid lg:grid-cols-2 xtra-small:grid-cols-1 xxtra-small:grid-cols-1 md:grid-cols-2 tablet:grid-cols-2 gap-5 mt-5">
        <div className="shadow-[0_4px_20px_0px_rgba(0,0,0,0.08)] rounded-md border-b-[3px] border-[#3459AB] h-auto p-4">
          <div className="flex cards-screen:flex-col items-center flex-nowrap md:flex-wrap lg:justify-between justify-between md:justify-center">
            <h2 className="text-[#444444] lg:text-left cards-screen:text-center text-[14px] lg:order-0 md:order-1 leading-[24px] sidebar-expanded:max-w-[130px]  max-w-[200px]">
              {" "}
          ...
          <div>
            {Static?.commercial_vehicles ? (
              <h2 className="lg:text-[24px] text-[20px] lg:text-left cards-screen:text-center leading-[32px] font-medium lg:mt-2  text-[#3459AB] ">
                {Static?.non_commercial_vehicles}
              </h2>
            ) : (
        ...
        <div className="shadow-[0_4px_20px_0px_rgba(0,0,0,0.08)] rounded-md border-b-[3px] border-[#AA1643]   h-auto p-4">
          ...
          <div>
            {Static?.non_commercial_vehicles >= 0 ? (
              <h2 className="lg:text-[24px] text-[20px] lg:text-left cards-screen:text-center leading-[32px] font-medium lg:mt-2  text-[#AA1643] ">
                {Static?.commercial_vehicles}
              </h2>
            ) : (
