      ...
      <div className="bg-white shadow-[0_4px_20px_0px_rgba(0,0,0,0.08)] rounded-md mt-10 mb-5 p-5">
        ...
        <div className="pt-5">
          ...
          <p className="text-[#444444] text-[14px] pt-4">
            ...
            velit suscipit scelerisque commodo urna at. Arcu quam erat ac
            volutpat sed nunc faucibus id.{" "}
          </p>
        </div>
      </div>
          ...
          <div className="pt-5 border-b border-[#ACACAC]">
            ...
            <ul className="pt-5">
              ...
              <li className="flex justify-between pb-4">
                ...
                <p className="text-[12px] text-[#0041B2] px-1.5 font-medium py-[2px] bg-[#E9F3FF] rounded-full">
                  Open
                </p>
              </li>
              <li className="flex justify-between pb-4">
          ...
          <div className="pt-5 ">
            ...
            <ul className="pt-5">
              ...
              <li className="pb-4">
                ...
                <p className="text-[14px] pt-2 text-[#898989]">
