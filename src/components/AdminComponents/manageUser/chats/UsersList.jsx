            ...
            <div className='h-full'>
                <div className='bg-[white] rounded shadow-[0_4px_20px_0px_rgba(0,0,0,0.08)] border-0 h-full'>
                    <div className='border-b px-6 py-[26px] flex items-center'>
                        <h1 className='text-[#444444] text-[16px] leading-[24px]'>Message</h1>
                        <MdOutlineKeyboardArrowDown className='text-[20px] mx-2' />
                        <div className='bg-[#FF8C00] rounded-full '>
                            <h2 className='text-white text-[16px] leading-[24px] px-2 py-[2px] font-semibold'>12</h2>
                        </div>
                    </div>
                    <div className='p-3'>
                                ...
                                <div className='pt-6  '>
                                    <div className='flex justify-between px-1'>
                                        <div className='flex items-center'>
                                            ...
                                            <div className='px-3'>
                                                <h2 className='text-[12px] leading-[18px] font-semibold text-[#444444]'>Elmer Laverty</h2>
                                                <p className='text-[12px] text-[#898989] leading-[18px]'>Haha oh man </p>
                                            </div>
                                        </div>
                                        <div>
