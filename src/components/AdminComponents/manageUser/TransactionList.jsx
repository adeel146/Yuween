...
const TransactionList = () => {
  ...
  return (
    <>
      ...
      <Popup id="job-modal" modalOpen={show} data={<Refund setShow={(val) => setShow(val)} />} onClose={() => setShow(false)} />
                ...
                <thead className="text-xs font-semibold bg-[#FFF8EF] border-0">
                  <tr className='text-[#626973]'>
                    ...
                    <th className="px-5 py-4 pr-[25px] whitespace-nowrap w-px">
                      <div className="font-semibold text-[14px] text-left">ID </div>
                    </th>
                    <th className="px-5 py-4 pr-[25px] whitespace-nowrap">
                      <div className="font-semibold text-[14px] text-left">Vehicle</div>
                    </th>
                    <th className="px-5 py-4 pr-[25px] whitespace-nowrap">
                    ...
                    <th className="px-5 py-4 pr-[25px] whitespace-nowrap">
                      <div className="font-semibold text-[14px] text-left">Renter  </div>
                    </th>
                    <th className="px-5 py-4 pr-[25px] whitespace-nowrap">
                      <div className="font-semibold text-[14px] text-left">Amount</div>
                    </th>
                    ...
                    currentItems.map((_, i) =>
                      <tr className=' cursor-pointer  ' >
                        ...
                        <td className="px-5 py-4 pr-[25px] whitespace-nowrap">
                          <div className="text-left text-[14px] text-[#898989]">1378</div>
                        </td>
                        <td className="px-5 py-4 pr-[25px] whitespace-nowrap">
                        ...
                        <td className="px-5 py-4 pr-[25px] whitespace-nowrap">
                          <div className='flex justify-start'>
                            ...
                            <div className="text-center px-2.5 py-[3px] text-[12px] leading-[16px] text-[#8E3F3A]  rounded-full bg-[#F0DFD6]">Pendding</div>
                          </div>
                        </td>
                        <td className="flex items-center px-4 py-4 pr-[25px] whitespace-nowrap">
                          <div className='h-[28px] w-[28px] rounded-full'>
                            <img src={rent} alt="rent_image" className='object-cover' />
                          </div>
                          <div className="text-left text-[14px] text-[#898989] px-2.5">hell</div>
                        </td>
                        <td className="px-5 py-4 pr-[25px] whitespace-nowrap">
                          <div className="text-left text-[14px] text-[#898989]"><span className='text-[#FF8C00]'>33 000 FCFA </span></div>
                        </td>

                        <td className="px-5 py-4 pr-[25px] whitespace-nowrap">
                          <div className='flex justify-center'>
                            <button onClick={(e) => openPopup(e)} className='bg-[#FF8C00] text-[14px] font-semibold text-white px-[22px] h-[30px] rounded-md'>Refund</button>
                          </div>
                        </td>
                      </tr>
                    )
