...
const CarRequest = () => {
  let request = [
    {
      heading: "Renault twingo",
      period: "Renault twingo",
      periodDate: "28-30 janv.",
      periodTime: "Time left: 24:00:00",
      pic: review,
      price: "50 000",
      status: "Approved",
      reason: "",
              ...
              <div
                className={`${
                  item?.status === "Approved"
                    ? "bg-[#ECFFEC] text-[#6ABD8B]"
                    : item?.status === "Ended"
                    ? "bg-[#DCDCDC] text-[#363636]"
                    : item.status === "Pending"
                    ? "bg-[#F0DFD6] text-[#8E3F3A]"
                    : item.status === "Rejected"
                    ? "bg-[#FFE7E7] text-[#F04438]"
                    : item.status === "Ongoing"
                    ? "bg-[#FFECD6] text-[#FF8C00]"
                    : ""
                } rounded-full text-center lg:mt-6 px-3.5 py-1 text-[16px] leading-[22px] max-w-[70%] lg:ml-auto xxtra-small:text-[14px] xxtra-small:leading-[26px]`}
              >
                <h2>{item?.status}</h2>
              </div>
            </div>
