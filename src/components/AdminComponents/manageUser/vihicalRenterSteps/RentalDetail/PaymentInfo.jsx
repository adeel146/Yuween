          ...
          <div className="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-5">
            {Array(4)
              ...
              .map((_, i) => (
                <div
                  key={i}
                  className="bg-white border-0 shadow-[0_4px_20px_0px_rgba(0,0,0,0.08)] rounded-md p-5"
                >
                  <h1 className="text-[18px] leading-[20px] text-[#444444]">
                    {titleArray[i]}
                  </h1>
                  <div className="flex flex-wrap  justify-between items-center pt-[34px]">
                    <h2 className="text-[42.55px] leading-[39px] text-[#FF8C00] font-semibold">
                      115
                    </h2>
        ...
        <div className="bg-white border-0 shadow-[0_4px_20px_0px_rgba(0,0,0,0.08)] rounded-md p-5 mt-5">
          ...
          <div className="grid grid-cols-2 gap-3 items-center pt-5">
            <div>
              ...
              <div className="">
                <h2 className="text-[#444444] text-[14px] leading-[20px]">
                  ID Card
                </h2>
                <p className="text-[14px] text-[#898989] pt-5 xxtra-small:pt-3 leading-[22px]">
                  15 Sep, 2023
                </p>
              </div>
              <div className="pt-4">
                    ...
                    <thead className="text-xs font-medium bg-[#FFF8EF] border-slate-200">
                      <tr className="text-[#626973]">
                        <th className="px-4 py-3 whitespace-nowrap w-px">
                          <div className="font-medium text-[14px] text-left">
                            Mobile Money{" "}
                          </div>
                        </th>
