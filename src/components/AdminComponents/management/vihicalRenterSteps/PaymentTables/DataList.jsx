...
const DataList = ({ setDetail }) => {
                            ...
                            <thead className="text-xs font-[500] bg-[#FFF8EF] border-0">
                                <tr className='text-[#626973]'>
                                    ...
                                    <th className="px-4 py-4 pr-[25px] whitespace-nowrap w-px">
                                        <div className="font-[500] text-[14px] text-left">Payment ID </div>
                                    </th>
                                    <th className="px-4 py-4 pr-[25px] whitespace-nowrap">
                                        <div className="font-[500] text-[14px] text-center">Payment Category</div>
                                    </th>
                                    <th className="px-4 py-4 pr-[25px] whitespace-nowrap">
                                        <div className="font-[500] text-[14px] text-left">Payment Name</div>
                                    </th>
                                    <th className="px-4 py-4 pr-[25px] whitespace-nowrap">
                                        <div className="font-[500] text-[14px] text-left">Payment Status</div>
                                    </th>
                                    <th className="px-4 py-4 pr-[25px] whitespace-nowrap">
                            ...
                            <tbody className="text-sm ">
                                {
                                    currentItems.map((_, i) =>
                                        <tr className=' cursor-pointer  ' >
                                            ...
                                            <td className="px-4 py-4 pr-[25px] whitespace-nowrap">
                                                <div className="text-center text-[14px] text-[#898989]">Mobile Money</div>
                                            </td>
                                            <td className="px-4 py-4 pr-[25px] whitespace-nowrap">
                                                <div className="text-left text-[14px] text-[#898989]">Orange</div>
                                            </td>
                                            <td className="px-4 py-4 pr-[25px] whitespace-nowrap">
                                                <div className="text-center w-fit py-[3px] px-2.5 text-[12px] leading-4 text-[#0041B2]  rounded-full bg-[#E9F3FF]">
                                                    Active</div>
                                            </td>
  ...
  transition duration-150 ease-in-out right-7 origin-top lg:w-[14%] "
                                                        >
                                                            ...
                                                            <li class="rounded-sm flex items-center px-2 py-2 hover:bg-gray-100">
