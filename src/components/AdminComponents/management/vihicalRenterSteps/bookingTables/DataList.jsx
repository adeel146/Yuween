...
const DataList = ({ setDetail }) => {
    ...
    return (
        <>
            ...
            <Popup id="job-modal" modalOpen={show} data={<CancelBooking setShow={(val) => setShow
                (val)} />} />
                            ...
                            <thead className="text-xs font-semibold bg-[#FFF8EF] border-0">
                                <tr className='text-[#626973]'>
                                    ...
                                    <th className="px-4 py-4 pr-[25px] whitespace-nowrap">
                                        <div className="font-semibold text-[14px] text-left">Vehicle Name</div>
                                    </th>
                                    <th className="px-4 py-4 pr-[25px] whitespace-nowrap">
                                        <div className="font-semibold text-[14px] text-center">Booking  Status</div>
                                    </th>
                                    <th className="px-4 py-4 pr-[25px] whitespace-nowrap">
                                        <div className="font-semibold text-[14px] text-left">City</div>
                                    </th>
                                    <th className="px-4 py-4 pr-[25px] whitespace-nowrap">
                                        <div className="font-semibold text-[14px] text-left">Owner Email</div>
                                    </th>
                                    <th className="px-4 py-4 pr-[25px] whitespace-nowrap">
                                        <div className="font-semibold text-[14px] text-left">Payout  </div>
                                    </th>
                                    <th className="px-4 py-4 pr-[25px] whitespace-nowrap">
                                        <div className="font-semibold text-[14px] text-left">Total Amount  </div>
                                    </th>
                                    <th className="px-4 py-4 pr-[25px] whitespace-nowrap">
                            ...
                            <tbody className="text-sm ">
                                {
                                    currentItems.map((_, i) =>
                                        <tr className=' cursor-pointer  ' >
                                            ...
                                            <td className="px-4 py-4 pr-[25px] whitespace-nowrap">
                                                <div className="text-left text-[14px] text-[#898989]">Done</div>
                                            </td>

                                            <td className="px-4 py-4 pr-[25px] whitespace-nowrap">
                                                <div className="text-left text-[14px] text-[#898989]">50 000 FCFA</div>
                                            </td>
                                            <td className="px-4 py-4 pr-[25px] whitespace-nowrap">
  ...
  transition duration-150 ease-in-out right-7 origin-top lg:w-[14%]  "
                                                        >
                                                            ...
                                                            <li onClick={(e) => openPopup(e)}  class="rounded-sm flex items-center px-2 py-2 hover:bg-gray-100">
